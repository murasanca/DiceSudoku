    ...
    public class ES:MonoBehaviour
    {
        ...
        private void Update()
        {
			...
			if(0!=Time.timeScale)
			{
				...
				if(k.escapeKey.wasPressedThisFrame||k.pKey.wasPressedThisFrame||k.xKey.wasPressedThisFrame)
					e.onClick.Invoke();
				else if(81==s)
				{
					if(gC.bLGO.activeSelf&&(0>m.scroll.y.ReadValue()||k.aKey.wasPressedThisFrame||k.downArrowKey.wasPressedThisFrame||k.homeKey.wasPressedThisFrame||k.leftArrowKey.wasPressedThisFrame||k.pageDownKey.wasPressedThisFrame||k.qKey.wasPressedThisFrame||k.sKey.wasPressedThisFrame))l.onClick.Invoke();
					else if(gC.bRGO.activeSelf&&(0<m.scroll.y.ReadValue()||k.dKey.wasPressedThisFrame||k.eKey.wasPressedThisFrame||k.endKey.wasPressedThisFrame||k.pageUpKey.wasPressedThisFrame||k.rightArrowKey.wasPressedThisFrame||k.upArrowKey.wasPressedThisFrame||k.wKey.wasPressedThisFrame))r.onClick.Invoke();
				}
				else // if(81!=s)
				{
					if(k.backspaceKey.wasPressedThisFrame||k.deleteKey.wasPressedThisFrame||k.digit0Key.wasPressedThisFrame||k.numpad0Key.wasPressedThisFrame)gC.D(s);
					else if(k.digit1Key.wasPressedThisFrame||k.numpad1Key.wasPressedThisFrame)gC.W(1,s);
					else if(k.digit2Key.wasPressedThisFrame||k.numpad2Key.wasPressedThisFrame)gC.W(2,s);
					else if(k.digit3Key.wasPressedThisFrame||k.numpad3Key.wasPressedThisFrame)gC.W(3,s);
					else if(k.digit4Key.wasPressedThisFrame||k.numpad4Key.wasPressedThisFrame)gC.W(4,s);
					else if(k.digit5Key.wasPressedThisFrame||k.numpad5Key.wasPressedThisFrame)gC.W(5,s);
					else if(k.digit6Key.wasPressedThisFrame||k.numpad6Key.wasPressedThisFrame)gC.W(6,s);
					else if(k.digit7Key.wasPressedThisFrame||k.numpad7Key.wasPressedThisFrame)gC.W(7,s);
					else if(k.digit8Key.wasPressedThisFrame||k.numpad8Key.wasPressedThisFrame)gC.W(8,s);
					else if(k.digit9Key.wasPressedThisFrame||k.numpad9Key.wasPressedThisFrame)gC.W(9,s);
				}
			}
        ...
        public void E()
        {
            ...
            rIGO.SetActive(PP.A=!rIGO.activeSelf);
        }
